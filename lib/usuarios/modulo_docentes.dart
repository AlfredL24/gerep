...
class ModuloDocentes extends StatefulWidget {
  @override
  _ModuloDocentesState createState() => _ModuloDocentesState();
}

class _ModuloDocentesState extends State<ModuloDocentes> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Lista de Docentes")),
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            final usuarios = snapshot.data!
                .where((usuario) => usuario.rol.toLowerCase() == 'profesor')
                .toList(); //Lista de usuarios filtrada por rol profesor
